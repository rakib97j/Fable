...
export default function EbookGenres() {
  ...
  return (
    <section className="w-full py-12 md:py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto font-sans">
      {/* Title Header with Scroll Fade-In */}
      <motion.div
      ...
      {/* Grid container with Framer Motion staggered reveal */}
      <motion.div
      ...
      >
        ...
        <motion.div variants={itemVariants} className="md:col-span-6 flex">
          <div className="group relative w-full h-[400px] md:h-full min-h-[420px] overflow-hidden bg-zinc-900 border-2 border-zinc-200/20 dark:border-zinc-800/60 shadow-lg hover:shadow-2xl transition-all duration-300 rounded-none cursor-pointer">
            <Image
              src={genres[0].image}
              alt={genres[0].title}
              fill
        ...
        <div className="md:col-span-6 flex flex-col gap-3.5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            <motion.div variants={itemVariants}>
              <div className="group relative w-full h-[190px] overflow-hidden bg-zinc-900 border-2 border-zinc-200/20 dark:border-zinc-800/60 shadow-lg hover:shadow-xl transition-all duration-300 rounded-none cursor-pointer">
                <Image
                  src={genres[1].image}
                  alt={genres[1].title}
                  fill
          ...
          {/* Sci-Fi (Wide) */}
          <motion.div variants={itemVariants}>
            <div className="group relative w-full h-[216px] overflow-hidden bg-zinc-900 border-2 border-zinc-200/20 dark:border-zinc-800/60 shadow-lg hover:shadow-xl transition-all duration-300 rounded-none cursor-pointer">
              <Image
                src={genres[3].image}
                alt={genres[3].title}
                fill
