...
export default function TopWriters() {
  ...
  return (
    <section className="w-full py-10 md:py-14 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      {/* Header with Feather Icon, Title & Top Right Link */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {isLoading ? (
          [1, 2, 3].map((idx) => (
            <div
              key={idx}
              className="bg-[#121215] p-7 sm:p-8 border border-zinc-800/80 rounded-xl animate-pulse min-h-55 flex flex-col justify-between"
            >
          ...
          writers.map((writer, index) => {
            ...
            return (
              <Link
                ...
                className="group relative bg-[#121215] p-7 sm:p-8 border border-zinc-800/80 hover:border-rose-600/60 hover:shadow-[0_10px_30px_-10px_rgba(248,59,96,0.25)] transition-all duration-300  flex-col justify-between min-h-55 rounded-none block"
              >
